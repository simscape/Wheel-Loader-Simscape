...
%
% |terrain_grid = stl_to_gridsurface('hills_terrain.stl',100,100,'n');|
% 
...
figure(1);
terrain_stl_data = stlread('hills_terrain.stl');
...
terrain_stl_points = stlread('hills_terrain.stl');
...
% terrain in Simscape Multibody models.  In the main model, this data
% is entered into the Grid Surface block.

load_system('wheel_loader_contact_lib');
open_system('wheel_loader_contact_lib/Terrain')
